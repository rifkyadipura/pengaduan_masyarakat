                        ...
                        <table>
                            <div class="row mt-2">
                                <div class="col-md-6 col-sm-4 col-xs-12">
                                    <label for="nama_masyarakat_rifky" class="form-label">Nama Mayarakat</label>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6 col-sm-4 col-xs-12">
                                    ...
                                    <br>
                                    <img src="../foto_pengaduan/<?= $foto_rifky;?>" alt="" style="width: 200px; height:100px;">
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-6 col-sm-4 col-xs-12">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-6 col-sm-4 col-xs-12">
                                    <label for="status_rifky" class="form-label">Status</label>
                                    <input type="text" name="status_rifky" id="status_rifky" class="form-control" value="<?=  $status_rifky ?>" readonly>
                                </div>
                                <div class="col-md-6 col-sm-4 col-xs-12">
                                    <label for="nama_petugas_rifky" class="form-label">Nama Petugas</label>
